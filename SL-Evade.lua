		...
		for _,i in pairs(self.Spells) do
			for l,k in pairs(GetEnemyHeroes()) do
				...
				if i.charName == k.charName then
					if not EMenu.Spells[_] then EMenu.Spells:Menu(_,""..i.charName.." | "..(self.str[i.slot] or "?").." - ".._) end
...
self.Spells = {
	["AatroxQ"]={charName="Aatrox",slot=0,type="Circle",delay=0.6,range=650,radius=250,speed=2000,addHitbox=true,danger=3,dangerous=true,proj="nil",killTime=0.225},
	...
	["CurseoftheSadMummy"]={charName="Amumu",slot=3,type="Circle",delay=0.25,range=0,radius=550,speed=999999999,addHitbox=false,danger=5,dangerous=true,proj="nil",killTime=1.25},
	...
	["Incinerate"]={charName="Annie",slot=1,type="Cone",delay=0.25,range=825,radius=80,speed=999999999,addHitbox=false,danger=2,dangerous=false,proj="nil",killTime=0},
	["InfernalGuardian"]={charName="Annie",slot=3,type="Circle",delay=0.25,range=600,radius=251,speed=999999999,addHitbox=true,danger=5,dangerous=true,proj="nil",killTime=0.3},
	...
	["StaticField"]={charName="Blitzcrank",slot=3,type="Circle",delay=0.25,range=0,radius=600,speed=999999999,addHitbox=false,danger=2,dangerous=false,proj="nil",killTime=0.2},
	...
	["BrandW"]={charName="Brand",slot=1,type="Circle",delay=0.85,range=900,radius=240,speed=999999999,addHitbox=true,danger=2,dangerous=false,proj="nil",killTime=0.275},
	...
	["DianaArcArc"]={charName="Diana",slot=0,type="Arc",delay=0.25,range=895,radius=195,speed=1400,addHitbox=true,danger=3,dangerous=true,proj="DianaArcArc",killTime=0},
	...
	["GalioIdolOfDurand"]={charName="Galio",slot=3,type="Circle",delay=0.25,range=0,radius=550,speed=999999999,addHitbox=false,danger=5,dangerous=true,proj="nil",killTime=1},
	...
	["GnarR"]={charName="Gnar",slot=3,type="Circle",delay=0.25,range=0,radius=500,speed=999999999,addHitbox=false,danger=5,dangerous=true,proj="nil",killTime=0.3},
	...
	["IllaoiR"]={charName="Illaoi",slot=3,type="Circle",delay=0.5,range=0,radius=450,speed=999999999,addHitbox=false,danger=3,dangerous=true,proj="nil",killTime=0.2},
	...
	["JarvanIVDragonStrike"]={charName="JarvanIV",slot=0,type="Line",delay=0.6,range=770,radius=70,speed=999999999,addHitbox=true,danger=3,dangerous=false,proj="nil",killTime=0},
	["JarvanIVEQ"]={charName="JarvanIV",slot=0,type="Line",delay=0.25,range=880,radius=70,speed=1450,addHitbox=true,danger=3,dangerous=true,proj="nil",killTime=0},
	...
	["KarthusLayWasteA2"]={charName="Karthus",slot=0,type="Circle",delay=0.625,range=875,radius=160,speed=999999999,addHitbox=true,danger=2,dangerous=false,proj="nil",killTime=0.2},
	...
	["OriannaQend"]={charName="Orianna",slot=0,type="Circle",delay=0,range=1500,radius=90,speed=1200,addHitbox=true,danger=2,dangerous=false,proj="nil",killTime=0.1},
	...
	["SejuaniArcticAssault"]={charName="Sejuani",slot=0,type="Line",delay=0,range=900,radius=70,speed=1600,addHitbox=true,danger=3,dangerous=true,proj="nil",killTime=0},
	...
	["SionR"]={charName="Sion",slot=3,type="Line",delay=0.5,range=800,radius=120,speed=1000,addHitbox=true,danger=3,dangerous=true,proj="nil",killTime=0},
	["SorakaQ"]={charName="Soraka",slot=0,type="Circle",delay=0.5,range=950,radius=300,speed=1750,addHitbox=true,danger=2,dangerous=false,proj="nil",killTime=0.275},
	...
	["VeigarDarkMatter"]={charName="Veigar",slot=1,type="Circle",delay=1.35,range=900,radius=225,speed=999999999,addHitbox=true,danger=2,dangerous=false,proj="nil",killTime=0.5},
	["VeigarEventHorizon"]={charName="Veigar",slot=2,type="Ring",delay=0.5,range=700,radius=80,speed=999999999,addHitbox=false,danger=3,dangerous=true,proj="nil",killTime=3.5},
	...
	["yasuoq2"]={charName="Yasuo",slot=0,type="Line",delay=0.4,range=550,radius=20,speed=999999999,addHitbox=true,danger=2,dangerous=true,proj="yasuoq2",killTime=0},
	...
	["yasuoq"]={charName="Yasuo",slot=0,type="Line",delay=0.4,range=550,radius=20,speed=999999999,addHitbox=true,danger=2,dangerous=true,proj="yasuoq",killTime=0},
...
function SLEvade:Pathfinding()
	for _,i in pairs(self.obj) do
		if i.spell.type == "Line" then
				...
				if GetDistance(i.p.startPos) < i.spell.range + myHero.boundingRadius + 200 then
					i.jp = jp
				else
					i.jp = nil
				end
				if GetDistance(i.p.endPos) > i.spell.range + myHero.boundingRadius + 200 then
					i.jp = nil
				end
